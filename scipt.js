...
opt_1.addEventListener('click', function () {
  document.getElementById('ani').style.background = '#017143';

  changeImage_1('./img1.png');

  function changeImage_1(newImageUrl) {
    const image = document.getElementById('ch-img');
...
opt_2.addEventListener('click', function () {
  document.getElementById('ani').style.background = 'rgb(255, 162, 178)';
...
opt_3.addEventListener('click', function () {
  document.getElementById('ani').style.background = 'purple';
